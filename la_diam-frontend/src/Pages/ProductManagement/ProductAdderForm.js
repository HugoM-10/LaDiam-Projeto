        ...
        <Container>
            ...
            <Form onSubmit={handleSubmit}>
                ...
                <Form.Group className="mb-3">
                    ...
                    <Form.Control as="textarea" name="description" placeholder="Description" onChange={handleChange} />
                </Form.Group>

                <Form.Group className="mb-3">
                    <Form.Label>Default Price</Form.Label>
                    <Form.Control type="number" name="default_price" placeholder="Default Price" onChange={handleChange} />
                </Form.Group>

                <Form.Group className="mb-3">
                    <Form.Label>Promotion (optional)</Form.Label>
                    <Form.Control type="number" step="0.01" name="promotion" placeholder="Promotion" onChange={handleChange} />
                </Form.Group>
            ...
            <CustomModal show={modalShow} onHide={handleModalClose} modalTitle={modalTitle} modalMsg={modalMsg} />
        </Container>
    );
};
